...
HelpConfig::HelpConfig(QSettings *settings)
	: Config(settings, Config::CONFIG_ELEM_HELP)
{

}

bool HelpConfig::load(const QSettings& settings)
{
	return true;
}

/*QXmlStreamReader& operator >> (QXmlStreamReader &reader, HelpConfig& config)
{
...
QXmlStreamWriter& operator << (QXmlStreamWriter &writer, const HelpConfig& config)
{
...
/*bool HelpConfig::readXmlFile(QIODevice& device, QSettings::SettingsMap& map)
{
	return true;
}

bool HelpConfig::writeXmlFile(QIODevice& device, const QSettings::SettingsMap& map)
{
	return true;
}*/
