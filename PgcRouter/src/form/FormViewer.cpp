...
//! [0]
FormViewer::FormViewer(NotebookService *service, QObject *parent)
    : QObject(parent)
...
QString FormViewer::statusToString(NotebookEntryStatus::Type status)
{
    switch (status) {
...
//! [2]
void FormViewer::noteChanged(const QList<NotebookEntryId> &entries)
{
    /**
...
//! [3]
void FormViewer::setNoteId(const NotebookEntryId &noteId)
{
    m_noteId = noteId;
...
QString FormViewer::title() const
{
    return m_title;
}

QString FormViewer::description() const
{
    return m_description;
}

QString FormViewer::dueDateTime() const
{
...
QString FormViewer::status() const
{
