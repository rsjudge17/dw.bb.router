...
#ifndef FORMVIEWER_HPP
#define FORMVIEWER_HPP
 ...
 *
 * The FormViewer class is an UI-independent representation of the note viewer,
 ...
 */
//! [0]
class FormViewer : public QObject
{
    Q_OBJECT
...
public:
    FormViewer(bb::pim::notebook::NotebookService *service, QObject *parent = 0);
