...
#ifndef FORMEDITOR_HPP
#define FORMEDITOR_HPP
 ...
 *
 * The FormEditor class is an UI-independent representation of the note editor,
...
public:
    ...
    FormEditor(bb::pim::notebook::NotebookService *service, QObject *parent = 0);
